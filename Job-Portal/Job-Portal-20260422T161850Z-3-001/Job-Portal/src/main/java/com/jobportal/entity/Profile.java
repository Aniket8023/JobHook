...
//
//	public Profile(Long id, String name, String email, String jobTitle, String company, String location, String about,
//			byte[] picture, byte[] resume, Long totalExp, List<String> skills, List<Experience> experiences,
//			List<Certification> certifications, List<Long> savedJobs) {
//		super();
//		this.id = id;
//		this.name = name;
//		this.email = email;
